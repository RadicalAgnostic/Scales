...
def showFret(string, fret, radius = 14, color = white, text = ""):
...
list_of_notes = ["E", "Eb", "D", "Db", "C", "B", 
                 "Bb", "A", "Ab", "G", "Gb", "F" ]



def findNote(string, fret):
...
def findFrets(string, fret):
    
    index = findNote(string, fret)
    
    all_frets = list_of_lists[index]
...
while running:
    ...
    for event in pg.event.get():
        ...
        if event.type == pg.VIDEORESIZE:
            ...
            test_list = findFrets(string, fret)
